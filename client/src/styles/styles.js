const styles = {
  ...
  active_indicator: "absolute bottom-[-27%] left-0 h-[2px] w-full bg-secColor",
  button:
    "w-[150px] text-white bg-secColor h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button:
